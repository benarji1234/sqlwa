...
{
	/// <summary>
	/// Description of C184753_IOWaitWidget_InconsistentOnDrillDown.
	/// </summary>
	[TestModule("0F5EC8CB-F1F5-4EC5-A419-845318CC800A", ModuleType.UserCode, 1)]
	public class C184753_IOWaitWidget_InconsistentOnDrillDown : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public C184753_IOWaitWidget_InconsistentOnDrillDown()
		{
		...
		void ITestModule.Run()
		{
			...
			try{
				...
				ATag iOWait  = "/dom[@domain='localhost:9291']//iframe[1]//table[#'entityOverviewDataTable']//a[@innertext='I/O Wait']";
