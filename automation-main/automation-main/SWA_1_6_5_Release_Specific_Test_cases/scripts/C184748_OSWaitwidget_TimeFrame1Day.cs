...
using SWA_1_6_5_Release_Specific_Test_cases.Scripts;
using SWA_1_6_5_Release_Specific_Test_cases.CommonUtilities;

namespace SWA_1_6_5_Release_Specific_Test_cases.Scripts
{
	/// <summary>
	/// Description of C184748_OSWaitwidget_TimeFrame1Day.
	/// </summary>
	[TestModule("69131CFD-DD38-4DA4-9EFE-66C78A8A59EF", ModuleType.UserCode, 1)]
	public class C184748_OSWaitwidget_TimeFrame1Day : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public C184748_OSWaitwidget_TimeFrame1Day()
		{
		...
		void ITestModule.Run()
		{
			...
			try{
				...
				Report.Log(ReportLevel.Info,"Wait for Login screen to be visible");
