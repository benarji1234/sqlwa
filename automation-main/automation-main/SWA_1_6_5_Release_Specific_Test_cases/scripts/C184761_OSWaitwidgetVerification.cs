...
{
	/// <summary>
	/// Description of C184761_OSWaitwidgetVerification.
	/// </summary>
	[TestModule("FD4D451E-0BD2-4B5B-AFA2-CCF44C7B94F5", ModuleType.UserCode, 1)]
	public class C184761_OSWaitwidgetVerification : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public C184761_OSWaitwidgetVerification()
		{
		...
		void ITestModule.Run()
		{
			...
			try{
				...
				var oSWait = commonRepo.IderaDashboard.BC2Un2.OSWait;
				oSWait.PerformClick();
				Delay.Seconds(3);
				...
				foreach(ATag query in sqlQueries){
					if(query.InnerText.Contains("DELETE") || query.InnerText.Contains("delete")){
						Report.Log(ReportLevel.Info,"Select Update query");
						query.PerformClick();
						break;
					}
				}
