...
{
	/// <summary>
	/// Description of C184765_InternalWaitwidget_onPerformingDrillDown.
	/// </summary>
	[TestModule("9D0F3A8D-B585-4F90-837C-3CCB429B3322", ModuleType.UserCode, 1)]
	public class C184765_InternalWaitwidget_onPerformingDrillDown : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public C184765_InternalWaitwidget_onPerformingDrillDown()
		{
		...
		void ITestModule.Run()
		{
			...
			try{
				...
				ATag logWait = "/dom[@domain='localhost:9291']//iframe[1]//table[#'entityOverviewDataTable']//a[@innertext='Internal Wait']";
				...
				//ATag statement = "/dom[@domain='localhost:9291']//iframe[1]//table[#'topStatementsDataTable']/tbody/tr[1]/?/?/a";
				//statement.MoveTo(Location.CenterLeft,1000);
				//statement.Click(Location.CenterLeft,1000);
