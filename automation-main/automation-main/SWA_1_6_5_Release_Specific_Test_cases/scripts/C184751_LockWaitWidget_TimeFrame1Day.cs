...
{
	/// <summary>
	/// Description of C184751_LockWaitWidget_TimeFrame1Day.
	/// </summary>
	[TestModule("C0EABE25-716B-413A-9EEE-17388EDFCCC4", ModuleType.UserCode, 1)]
	public class C184751_LockWaitWidget_TimeFrame1Day : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public C184751_LockWaitWidget_TimeFrame1Day()
		{
		...
		void ITestModule.Run()
		{
			...
			try{
				...
				Validate.AttributeEqual(commonRepo.IderaDashboard.BC2Un2.ContentInfo,"Visible","True");
				...
				Report.Log(ReportLevel.Info,"Click on Lock Waits in DB Highlights");
				var repo = SWA_1_6_5_Release_Specific_Test_casesRepository.Instance;
				ATag lockWait = "/dom[@domain='localhost:9291']//iframe[1]//table[#'entityOverviewDataTable']//a[@innertext='Lock Wait']";
				
				lockWait.PerformClick();
				Delay.Seconds(3);
				commonRepo.IderaDashboard.BC2Un2.Content.Click();
				SWAWebCommon.Scroll(commonRepo.IderaDashboard.BC2Un2.LockedStatementsInfo,"down");
				CommonUtilities.SWAWebCommon.Scroll(commonRepo.IderaDashboard.BC2Un2.LockedStatementsInfo,"down");
				Delay.Seconds(10);
				commonRepo.IderaDashboard.BC2Un2.WidgetContent1.PerformClick();
